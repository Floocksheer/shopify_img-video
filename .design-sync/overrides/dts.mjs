...
// forked from design-sync lib/dts.mjs — CTA and FAQ are real React components
// in this repo; let them through the ALL-CAPS enum-name heuristic.
const ALLCAPS_COMPONENTS = new Set(['CTA', 'FAQ']);
export const isComponentName = (n) => !n.endsWith('Props')
  && (ALLCAPS_COMPONENTS.has(n) || !/^[A-Z][A-Z0-9_]+$/.test(n))
